  ...
  return <main className="mechanical-shell min-h-screen bg-[#eef1f4] text-slate-950">
    ...
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 text-slate-900 backdrop-blur">
      <div className="mx-auto flex h-20 max-w-7xl items-center gap-6 px-4 sm:px-6">
        ...
        <nav className="ml-auto hidden items-center gap-6 text-sm font-semibold lg:flex"><a href="#listings">Browse</a><a href="#categories">Categories</a><Link href="/parts-wanted">Parts Wanted</Link><Link href="/shops">Local shops</Link><Link href="/tech-wire">Parts &amp; Industry News</Link><a href="/safety">Safety tips</a><a href="#business">For businesses</a></nav>
      ...
      {mobileNav && <nav className="grid gap-1 border-t border-slate-200 px-4 py-3 text-sm font-semibold lg:hidden"><a className="rounded-lg p-3 hover:bg-slate-100" href="#listings">Browse listings</a><a className="rounded-lg p-3 hover:bg-slate-100" href="#categories">Categories</a><Link className="rounded-lg p-3 hover:bg-slate-100" href="/parts-wanted">Parts Wanted</Link><Link className="rounded-lg p-3 hover:bg-slate-100" href="/shops">Local shops</Link><Link className="rounded-lg p-3 hover:bg-slate-100" href="/tech-wire">Parts &amp; Industry News</Link><a className="rounded-lg p-3 hover:bg-slate-100" href="/safety">Safety tips</a><a className="rounded-lg p-3 hover:bg-slate-100" href="#business">For businesses</a>{user?<><a className="rounded-lg p-3 hover:bg-slate-100" href="/account">My account</a><a className="rounded-lg p-3 hover:bg-slate-100" href="/messages">Messages</a><a className="rounded-lg p-3 hover:bg-slate-100" href="/notifications">Notifications</a><a className="rounded-lg p-3 text-red-700 hover:bg-red-50" href={signOutPath}>Sign out</a></>:<a className="rounded-lg border border-amber-500 bg-amber-400 p-3 text-center font-extrabold text-[#071a35] shadow-sm hover:bg-amber-300" href={signInPath}>Sign in or create account</a>}</nav>}
    </header>
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 md:py-20 lg:grid-cols-[minmax(0,.78fr)_minmax(0,1.22fr)] lg:items-center lg:gap-16">
        ...
        <div>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            ...
            <a href="https://www.facebook.com/share/1GRGa1eFPK/" target="_blank" rel="noopener noreferrer" aria-label="Follow Any-Part and Gear on Facebook" className="inline-flex size-11 items-center justify-center rounded-full bg-[#0b2345] text-white transition hover:bg-blue-800"><svg viewBox="0 0 24 24" aria-hidden="true" className="size-5 text-white" fill="currentColor"><path d="M13.6 22v-8h2.8l.4-3.2h-3.2v-2c0-.9.3-1.6 1.7-1.6H17V4.4c-.3 0-1.4-.1-2.6-.1-2.6 0-4.3 1.6-4.3 4.4v2.1H7.3V14h2.8v8h3.5Z"/></svg></a>
            <a href="https://www.instagram.com/apgmarketplace/" target="_blank" rel="noopener noreferrer" aria-label="Follow APG Marketplace on Instagram" className="inline-flex size-11 items-center justify-center rounded-full bg-[#0b2345] text-white transition hover:bg-fuchsia-700"><svg viewBox="0 0 24 24" aria-hidden="true" className="size-5 text-white" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg></a>
          </div>
        </div>
      </div>
    </section>
    ...
    <footer className="bg-[#06162d] text-slate-400"><div className="mx-auto grid max-w-7xl gap-5 px-4 py-8 text-sm sm:px-6 lg:grid-cols-[auto_1fr_auto] lg:items-center"><span className="font-bold text-white">ANY PART <b className="text-amber-400">& GEAR</b></span><div className="flex flex-wrap gap-x-5 gap-y-2 lg:justify-center"><a href="/terms" className="hover:text-white">Terms</a><a href="/privacy" className="hover:text-white">Privacy</a><a href="/affiliate-disclosure" className="hover:text-white">Affiliate Disclosure</a><a href="/community-guidelines" className="hover:text-white">Community Guidelines</a><a href="/trust" className="hover:text-white">Trust &amp; Transparency</a><a href="/support" className="hover:text-white">Support</a><a href="/safety" className="hover:text-white">Safety</a></div><div className="flex flex-wrap items-center gap-4"><a href="https://www.facebook.com/share/1GRGa1eFPK/" target="_blank" rel="noopener noreferrer" aria-label="APG on Facebook" className="hover:text-white"><svg viewBox="0 0 24 24" aria-hidden="true" className="size-5 text-white" fill="currentColor"><path d="M13.6 22v-8h2.8l.4-3.2h-3.2v-2c0-.9.3-1.6 1.7-1.6H17V4.4c-.3 0-1.4-.1-2.6-.1-2.6 0-4.3 1.6-4.3 4.4v2.1H7.3V14h2.8v8h3.5Z"/></svg></a><a href="https://www.instagram.com/apgmarketplace/" target="_blank" rel="noopener noreferrer" aria-label="APG on Instagram" className="hover:text-white"><svg viewBox="0 0 24 24" aria-hidden="true" className="size-5 text-white" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg></a><p>© 2026 Any-Part and Gear LLC</p>{user&&<a href={signOutPath} target="_top" className="hover:text-white">Sign out</a>}</div></div></footer>
  </main>;
}
