  ...
  return <main className="mechanical-shell min-h-screen bg-[#eef1f4] text-slate-950">
    ...
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 text-slate-900 backdrop-blur">
      <div className="mx-auto flex h-20 max-w-7xl items-center gap-6 px-4 sm:px-6">
        ...
        <nav className="ml-auto hidden items-center gap-7 text-sm font-semibold lg:flex"><a href="#listings">Browse</a><a href="#categories">Categories</a><a href="/shops">Local shops</a><a href="/tech-wire">Tech Wire</a><a href="/safety">Safety tips</a><a href="#business">For businesses</a></nav>
      ...
      {mobileNav && <nav className="grid gap-1 border-t border-slate-200 px-4 py-3 text-sm font-semibold lg:hidden"><a className="rounded-lg p-3 hover:bg-slate-100" href="#listings">Browse listings</a><a className="rounded-lg p-3 hover:bg-slate-100" href="#categories">Categories</a><a className="rounded-lg p-3 hover:bg-slate-100" href="/shops">Local shops</a><a className="rounded-lg p-3 hover:bg-slate-100" href="/tech-wire">APG Tech Wire</a><a className="rounded-lg p-3 hover:bg-slate-100" href="/safety">Safety tips</a><a className="rounded-lg p-3 hover:bg-slate-100" href="#business">For businesses</a>{user?<><a className="rounded-lg p-3 hover:bg-slate-100" href="/account">My account</a><a className="rounded-lg p-3 hover:bg-slate-100" href="/messages">Messages</a><a className="rounded-lg p-3 text-red-700 hover:bg-red-50" href={signOutPath}>Sign out</a></>:<a className="rounded-lg bg-[#0b2345] p-3 text-center text-white" href={signInPath}>Sign in or create account</a>}</nav>}
    </header>
