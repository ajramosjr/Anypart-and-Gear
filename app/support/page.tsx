...
export default function SupportPage() { return <LegalShell eyebrow="We’re here to help" title="Support" intro="Find the right next step for account, listing and safety concerns.">
  ...
  <div className="mt-8 flex flex-wrap gap-3"><Link href="/safety" className="rounded-md bg-[#0b2345] px-5 py-3 font-bold text-white">Read safety tips</Link><Link href="/community-guidelines" className="rounded-md border border-slate-300 px-5 py-3 font-bold">View marketplace rules</Link></div>
</LegalShell>; }
