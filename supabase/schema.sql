...
create table if not exists public.listings (
  ...
  category text not null check (category in ('Car Parts','Boat Parts','Boats for Sale','Motorcycles','Trucks','Trailers','Tools','RC & Hobby','Machinery','Workwear & Apparel','Vehicles for Sale','Other')),
